...
int main()
{
  ...
  auto split_view = dataview | std::views::split(delim) | std::views::drop(1) | std::views::take(array_width);

  auto reverse_split_view = dataview | std::views::reverse | std::views::split(delim) | std::views::drop(1) | std::views::take(array_width);
